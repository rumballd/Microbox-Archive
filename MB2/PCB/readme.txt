...
Today (20/12/2021) the main pcb is still under test. Files can be updated at anytime if required.
...
J1 and J2 are for dual side floppy fonction (R57 is the pull up resistor). Leave J1 open and populate J2 for ds floppy. If you want use an old version of MON09 with step rate
